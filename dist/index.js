...
async function validateRequest(context, rules) {
...
function readConfig() {
    ...
    var yamlValidators = JSON.parse(process.env.OBKA_VALIDATORS);
...
async function getTokenDecoder(name) {
